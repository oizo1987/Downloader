...
class GlpiRestApi94Provider extends AbstractProvider {
    ...
    protected function _getConfigContainer1Extra() {
        $tpl = new Smarty();
        $tpl = initSmartyTplForPopup($this->_centreon_open_tickets_path, $tpl, 'providers/GlpiRestApi94/templates', $this->_centreon_path);
